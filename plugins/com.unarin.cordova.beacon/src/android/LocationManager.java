...
public class LocationManager extends CordovaPlugin implements BeaconConsumer {
    ...
    private void tryToRequestMarshmallowLocationPermission() {
        ...
        try {
            ...
            builder.setTitle("La aplicación necesita acceso a su ubicación");
            builder.setMessage("Otorgue acceso a la ubicación para que esta aplicación pueda detectar beacons.");
