var ObjSalas = [{
        ...
        "major_beacon": "1",
        "menor_beacon": "1",
        "texto": "pasillo 1, aseo y limpieza",
        "direccion": "Lider",
        "longitud": "-70.6213801",
        "latitud": "-33.4291121"
    },
...
function Getposition(position) {
    ...
    if (objBeacon.length > 1) {
        var texto = "Bienvenido a " + " " + nombreSala + ", " + "presione la pantalla para comenzar a localizar productos y pasillos.";
        TransmitirVoz(texto)
    } else {
